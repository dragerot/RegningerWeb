CREATE TABLE IF NOT EXISTS STROMMAALINGER
(
  DATO DATE NOT NULL PRIMARY KEY ,
  TOTALT_FORBRUK NUMBER(8),
  UTLEIE_FORBRUK NUMBER(8),
  MELDING VARCHAR2 (30)
);
...
( ORDER_ID VARCHAR2 (12) NOT NULL PRIMARY KEY ,
  NAME VARCHAR2 (30) ,
  SSN VARCHAR2 (11) NOT NULL
);

CREATE INDEX IF NOT EXISTS CUSTOMER_SSN_FK_IDX ON CUSTOMER_ORDER(SSN ASC) ;
ALTER TABLE CUSTOMER_ORDER ADD CONSTRAINT IF NOT EXISTS CUSTOMER_CONSTRAINT_FK FOREIGN KEY ( SSN ) REFERENCES CUSTOMER ( SSN ) NOT DEFERRABLE ;
